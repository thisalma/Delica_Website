        ...
        <main class="max-w-7xl mx-auto px-6 py-8 flex-grow">
                ...
                <div class="bg-white shadow-lg p-6 rounded-xl">
                    ...
                    <div class="space-y-5">
                        <x-dashboard.icon-card
                            ...
                            icon="check-circle"
                            description="We deliver only premium-grade products ensuring freshness and safety." />

                        <x-dashboard.icon-card
                            title="Fast Delivery"
                            icon="truck"
                            description="Your favorite products delivered quickly and safely to your doorstep." />

                        <x-dashboard.icon-card
                            title="Worldwide Selection"
                            icon="globe"
                            description="Explore products from different countries and unique global flavors." />
                    </div>
                </div>
            ...
            <div class="mt-16 text-center">
                ...
                <div class="flex flex-col md:flex-row items-center justify-center gap-10">
                    <x-dashboard.step-card number="1" title="Search"
                        description="Browse our wide range of global products." icon="search" />
                    <x-dashboard.step-card number="2" title="Select"
                        description="Choose your favorite items and add to cart." icon="plus" />
                    <x-dashboard.step-card number="3" title="Order"
                        description="Complete your purchase in a few clicks." icon="shopping-bag" />
                    <x-dashboard.step-card number="4" title="Enjoy"
                        description="Sit back and enjoy your items." icon="smile" />
                </div>
            </div>
